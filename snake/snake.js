...
var ASM_CONSTS = {
  89358: () => { if (document.fullscreenElement) return 1; },  
 89404: () => { return Module.canvas.width; },  
 89436: () => { return parseInt(Module.canvas.style.width); },  
 89484: () => { document.exitFullscreen(); },  
 89511: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 89583: () => { if (document.fullscreenElement) return 1; },  
 89629: () => { return Module.canvas.width; },  
 89661: () => { return screen.width; },  
 89686: () => { document.exitFullscreen(); },  
 89713: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 89907: () => { return window.innerWidth; },  
 89933: () => { return window.innerHeight; },  
 89960: () => { if (document.fullscreenElement) return 1; },  
 90006: () => { return Module.canvas.width; },  
 90038: () => { return parseInt(Module.canvas.style.width); },  
 90086: () => { if (document.fullscreenElement) return 1; },  
 90132: () => { return Module.canvas.width; },  
 90164: () => { return screen.width; },  
 90189: () => { return window.innerWidth; },  
 90215: () => { return window.innerHeight; },  
 90242: () => { if (document.fullscreenElement) return 1; },  
 90288: () => { return Module.canvas.width; },  
 90320: () => { return screen.width; },  
 90345: () => { document.exitFullscreen(); },  
 90372: () => { if (document.fullscreenElement) return 1; },  
 90418: () => { return Module.canvas.width; },  
 90450: () => { return parseInt(Module.canvas.style.width); },  
 90498: () => { document.exitFullscreen(); },  
 90525: ($0) => { Module.canvas.style.opacity = $0; },  
 90563: () => { return screen.width; },  
 90588: () => { return screen.height; },  
 90614: () => { return window.screenX; },  
 90641: () => { return window.screenY; },  
 90668: () => { return window.devicePixelRatio; },  
 90704: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 90757: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90808: () => { Module.canvas.style.cursor = 'none'; },  
 90845: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 91101: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91152: () => { if (document.pointerLockElement) return 1; },  
 91199: () => { if (document.fullscreenElement) return 1; },  
 91245: () => { return window.innerWidth; },  
 91271: () => { return window.innerHeight; }
};
